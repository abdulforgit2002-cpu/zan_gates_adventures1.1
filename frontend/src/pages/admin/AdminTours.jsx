...
/* =========================================================
   ADMIN TOURS PAGE
   (rendered inside AdminLayout — no sidebar of its own)
   ========================================================= */
...
function AdminTours() {
    ...
    const statistics = useMemo(() => {
        const active = tours.filter(
            (tour) =>
                String(tour.status).toUpperCase() === "ACTIVE"
        ).length;
        ...
        return { active, inactive, featured: featuredTours };
    }, [tours]);
    ...
    const handleRefresh = () => fetchTours(true);
    ...
    const handleViewTour = async (tour) => {
        try {
            ...
            const normalizedTour = normalizeTourDetails(
                response,
                tour
            );
    ...
    const handleStatusChange = async (tour) => {
        const currentStatus = String(tour.status || "").toUpperCase();
        const newStatus =
    ...
    const handleFeaturedChange = async (tour) => {
        const newFeatured = !Boolean(tour.featured);
    ...
    const handleDelete = async (tour) => {
        ...
        try {
            ...
            setNotification({
                type: "error",
                message:
                    err?.message || "Unable to delete tour.",
            });
        } finally {
            setActionLoading(false);
        }
        ...
        <div className="admin-tours-page">
            ...
            <div className="admin-tours-header">
                <div>
                    ...
                    <h1>Tours</h1>
                    <p>
                        Create, manage and organize your Zanzibar
                        experiences.
                    </p>
                </div>
            ...
            <div className="tour-stat-grid">
                <div className="tour-stat-card">
                    <div className="tour-stat-icon">◫</div>
                    <div>
            ...
            <div className="tour-table-card">
                ...
                {tours.length === 0 ? (
                    <div className="empty-tours">
                        <div className="empty-tour-icon">◫</div>
                        <h3>No tours found</h3>
                        <p>
                            Try adjusting your filters or create your
                            first tour.
                        </p>
                        <Link
                            to="/admin/tours/new"
                                ...
                                {tours.map((tour) => (
                                    <tr key={tour.id}>
                                        ...
                                        <td>
                                            ...
                                            {Number(tour.price_count) > 1 && (
                                                <span className="price-count">
                                                    +
                                                    {Number(tour.price_count) -
                                                        1}{" "}
                                                    more
                                                </span>
                                            )}
                ...
                <div className="tour-pagination">
                    ...
                    <div className="pagination-controls">
                        ...
                        <button
                            ...
                            disabled={
                                !pagination.has_next_page || refreshing
                            }
                        >
                            →
                        </button>
