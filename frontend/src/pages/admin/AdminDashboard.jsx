...
const AdminDashboard = () => {
    ...
    */
    ...
    const financialSummary =
        Array.isArray(dashboard.financial_summary)
            ? dashboard.financial_summary
            : [];

    const recentBookings =
        Array.isArray(dashboard.recent_bookings)
            ? dashboard.recent_bookings
            : [];

    const upcomingBookings =
        Array.isArray(dashboard.upcoming_bookings)
            ? dashboard.upcoming_bookings
            : [];

    const tourPerformance =
        Array.isArray(dashboard.tour_performance)
        ...
        <>
            ...
            <section className="admin-stat-grid">
                ...
                <div className="admin-stat-card">
                    ...
                    <strong>
                        {Number(statistics.total_bookings || 0)}
                    </strong>
                ...
                <div className="admin-stat-card">
                    <span>Pending</span>
                    <strong>
                        {Number(statistics.pending_bookings || 0)}
                    </strong>
                ...
                <div className="admin-stat-card">
                    <span>Confirmed</span>
                    <strong>
                        {Number(statistics.confirmed_bookings || 0)}
                    </strong>
                ...
                <div className="admin-stat-card">
                    <span>Completed</span>
                    <strong>
                        {Number(statistics.completed_bookings || 0)}
                    </strong>
                ...
                <div className="admin-stat-card">
                    <span>Cancelled</span>
                    <strong>
                        {Number(statistics.cancelled_bookings || 0)}
                    </strong>
                    <small>Cancelled enquiries</small>
                </div>
            ...
            <section className="admin-section">
                ...
                <div className="admin-financial-grid">
                    {financialSummary.length === 0 ? (
                        ...
                        financialSummary.map((financial) => (
                            <div
                            ...
                            >
                                ...
                                <small>
                                    ...
                                    booking{financial.booking_count !== 1 ? "s" : ""}
                                </small>
                            </div>
                        ))
                    )}
                            ...
                            {recentBookings.length === 0 ? (
                                ...
                                recentBookings.map((booking) => (
                                    <tr key={booking.id}>
                                        ...
                                        <td>
                                            <span
                                                className={`admin-status ${statusClass(booking.status)}`}
                                            >
                                                {booking.status}
                                            </span>
                                        </td>
                ...
                <div className="admin-upcoming-list">
                    ...
                    {upcomingBookings.length === 0 ? (
                        ...
                        upcomingBookings.map((booking) => {
                            const date = formatShortDate(booking.travel_date);
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="admin-upcoming-info">
                                        <strong>{booking.tour_title}</strong>
                                        <span>
                                            {booking.full_name}
                                            {" · "}
                                            {booking.adults} adult
                        ...
                        tourPerformance.map((tour) => (
                            ...
                            >
                                <div>
                                    ...
                                    <span>
                                        {tour.booking_count} total booking
                                        {tour.booking_count !== 1 ? "s" : ""}
                                    </span>
                                </div>
                                ...
                                <div className="admin-tour-metrics">
                                    <span>
                                        Pending{" "}
                                        <strong>{tour.pending_count}</strong>
                                    </span>
                                    <span>
                                        Confirmed{" "}
                                        <strong>{tour.confirmed_count}</strong>
                                    </span>
                                    <span>
                                        Completed{" "}
                                        <strong>{tour.completed_count}</strong>
                                    </span>
                                </div>
                            </div>
                        ))
